...
Error: Signature mismatch:
       ...
       The type int -> int is not compatible with the type
         int -> (float * string ref) list
       Type int is not compatible with type (float * string ref) list
|}]
...
Error: Signature mismatch:
       ...
       is not included in
         val f : 'a list * 'b list -> int
       The type 'a list * 'b ref -> int is not compatible with the type
         'a list * 'c list -> int
       Type 'b ref is not compatible with type 'c list
|}]
